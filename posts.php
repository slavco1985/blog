        ...
        $sql_post = "SELECT * FROM posts ORDER BY post_id DESC  LIMIT $limit OFFSET $offset   ";
        ...
        while ($row = mysqli_fetch_assoc($result_posts)) {
            ...
            echo"<a href=\"show_whole_post.php?post_id=$post_id&cat_id=$cat_id\"><img src=\"admin/uploads/$post_image\"    class=\"media-object\" style=\"width:200px\"></a>";
            echo" </div>";
